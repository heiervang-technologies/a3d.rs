...
fn bunny_80x24_snapshot() {
    ...
    assert_eq!(output, expected, "Bunny 80x24 snapshot mismatch — rendering has regressed");
}
...
fn bunny_80x24_rotated_snapshot() {
    ...
    assert_eq!(output, expected, "Bunny 80x24 rotated snapshot mismatch — rendering has regressed");
}
...
fn cow_80x24_snapshot() {
    ...
    assert_eq!(output, expected, "Cow 80x24 snapshot mismatch — rendering has regressed");
}
...
fn teapot_80x24_snapshot() {
    ...
    assert_eq!(output, expected, "Teapot 80x24 snapshot mismatch — rendering has regressed");
}
